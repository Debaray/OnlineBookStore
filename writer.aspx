<%@ Page Language="C#" AutoEventWireup="true" CodeFile="writer.aspx.cs" Inherits="writer" %>
...
<br />
    ...
    <h3 style="color:white;font-size:30pt;background-color:rgba(0,0,0,0.8);align:center;padding-left:500px;">Online Book Store</h3>
		...
		<h1 id="eventheader">OUR WRITERS</h1>
			<div class="container"><!--everything on the page-->
			<br /><br />
					...
					<div class = "bookname"><%#Eval("writer_name")%></div>
					<div class = "bookname">Country : <%#Eval("country")%></div>
					<div class = "bookprice">website : <%#Eval("web")%></div>
