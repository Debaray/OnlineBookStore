...
public partial class admin_add_item : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      //  }
        ...
        {
            dd.Items.Add(dr["category_name"].ToString());
    ...
    protected void b1_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "INSERT INTO `books` (`id`,`book_name`,`writer_name`,`category`, `price`, `image`) VALUES (NULL,'" + t1.Text + "', '" + t2.Text + "','" + t3.Text + "'," + t4.Text + ", '" + b.ToString() + "')";
        cmd.ExecuteNonQuery();
        sqlconn.Close();
